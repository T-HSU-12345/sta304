...
Where the nominator $\sum h$ represents the sum of all the hours combined, and the denominator $n$ represent the total number of answers.
...
# Discussion
As shown above, the three major cities across both provinces have people following a similar normal distribution curve. Most people a
