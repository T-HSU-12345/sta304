...
We chose cities that are in the southern parts of their respective provinces, as shown below. These cities share similar latitudes and therefore should have similar hours of daylight (Not factoring weather).
...
The mean is calculate using this function

*The RMarkdown file for this report can be found at: https://github.com/T-HSU-12345/sta304/tree/master/content/post*

# Discussion
As shown above, the three major cities accross both provinces have people following a similar normal distribution curve.
